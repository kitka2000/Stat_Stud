---
title: "Regression models: exercices"
---
...
Fit the ``best'' polynomial model to this data
...
5. Propose two other parametrizations of the asymptotic regression model which involves 
  ...
  i) the weight at birth $w_0$ (when $t=0$), the limit weight $w_\infty$ (when $t\to \infty$) and $k$
  ii) the weight at birth, the weight at the end of the study $w_{14}$ and the ratio $r=(w_{14}-W_{7})/(w_7 - w_0)$
...
10. Compare the predicted weight of this rat with the predicted weight for ID `B38836`.
